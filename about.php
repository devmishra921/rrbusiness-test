...
body{font-family:system-ui,Segoe UI,Roboto,Helvetica,Arial,sans-serif;background:#f5f5f5;line-height:1.5}
...
/* ABOUT SECTION (full‑width minus 40 px each side) */
.about-section{width:calc(100% - 80px);margin:48px auto;padding:40px;background:#fff;border-radius:8px;box-shadow:0 4px 20px rgba(0,0,0,.05)}
.about-section h1{text-align:center;color:var(--brand-dark);margin-bottom:18px}
.about-subsections{margin-top:30px}
.about-subsections h2{color:var(--brand-dark);margin:24px 0 10px;font-size:1.3rem}
.about-subsections p,.about-subsections ul{margin-bottom:20px;font-size:.95rem}
.about-subsections ul{padding-left:18px}
@media(max-width:576px){.about-section{margin:32px 20px;padding:28px}}
...
<div class="about-section">
  ...
  <p>R.R. Business is a trusted name in the Indian spice industry, known for delivering 100% pure, authentic, and hygienically processed spices. Our products are carefully sourced directly from farmers and undergo rigorous cleaning, roasting, blending, and packaging using advanced automated machines. We aim to deliver not only taste but also health and purity in every pinch of spice.</p>

  <div class="about-subsections">
    <h2>Our Mission</h2><p>To serve our customers with premium-grade Indian spices that are natural, fresh, and free from additives, while empowering local farmers and promoting sustainable sourcing.</p>
    <h2>What We Offer</h2>
    <ul><li>✅ Haldi Powder</li><li>✅ Dhaniya Powder</li><li>✅ Garam Masala</li><li>✅ Chicken Masala, Meat Masala, and more</li><li>✅ Besan (Gram Flour), Sattu, Jowar/Millet Flour</li></ul>
    <h2>Why Choose Us?</h2>
    <p>✔ Hygienically processed spices<br>✔ Direct farmer‑sourcing<br>✔ Modern machinery with traditional recipes<br>✔ Quality assurance at every stage<br>✔ Affordable pricing with premium quality</p>
    <h2>Meet Our Team</h2>
    <p>Behind every successful product is a dedicated team. Our skilled workforce includes farmers, quality analysts, packaging specialists, and logistics personnel—all working together to bring R.R. Business products from farm to your kitchen.</p>
  </div>
</div>
...
<footer>
  <div class="footer-container">
    ...
    <div class="footer-col"><h4>📱 Follow Us</h4>
      <ul><li><a href="#"><i class="fab fa-facebook"></i> Facebook</a></li><li><a href="https://www.instagram.com/rrbusiness2025" target="_blank"><i class="fab fa-instagram"></i> Instagram</a></li><li><a href="https://wa.me/917678853017" target="_blank"><i class="fab fa-whatsapp"></i> WhatsApp</a></li></ul>
    </div>
    <!-- NEW 4th COLUMN -->
    <div class="footer-col"><h4>🛍️ Our Products</h4>
      <ul><li>✨ Haldi Powder</li><li>✨ Mirch Powder</li><li>✨ Garam Masala</li><li>✨ Chat Masala</li></ul>
    </div>
  </div>
